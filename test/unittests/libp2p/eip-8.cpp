...
BOOST_AUTO_TEST_CASE(test_discovery_packets)
{
    ...
    BOOST_CHECK_EQUAL(findnode.target, NodeID("ca634cae0d49acb401d8a4c6b6fe8c55b70d115bf400769cc1400f3258cd31387574077f301b421bc84df7266c44e9e6d569fc56be00812904767bf5ccd1fc7f"));
    ...
    BOOST_CHECK_EQUAL(neighbours.neighbours[0].node, NodeID("3155e1427f85f10a5c9a7755877748041af1bcd8d474ec065eb33df57a97babf54bfd2103575fa829115d224c523596b401065a97f74010610fce76382c0bf32"));
	BOOST_CHECK_EQUAL(neighbours.neighbours[1].endpoint, NodeIPEndpoint(bi::address::from_string("1.2.3.4"), 1, 1));
    BOOST_CHECK_EQUAL(neighbours.neighbours[1].node, NodeID("312c55512422cf9b8a4097e9a6ad79402e87a15ae909a4bfefa22398f03d20951933beea1e4dfa6f968212385e829f04c2d314fc2d4e255e0d3bc08792b069db"));
    ...
    BOOST_CHECK_EQUAL(neighbours.neighbours[2].node, NodeID("38643200b172dcfef857492156971f0e6aa2c538d8b74010f8e140811d53b98c765dd2d96126051913f44582e8c199ad7c6d6819e9a56483f637feaac9448aac"));
    ...
    BOOST_CHECK_EQUAL(neighbours.neighbours[3].node, NodeID("8dcab8618c3253b558d459da53bd8fa68935a719aff8b811197101a4b2b47dd2d47295286fc00cc081bb542d760717d1bdd6bec2c37cd72eca367d6dd3b9df73"));
...
public:
    ...
    static shared_ptr<TestHandshake> runWithInput(Keys::Secret _hostAlias, bytes _packet, NodeID _remoteID = NodeID());
...
shared_ptr<TestHandshake> TestHandshake::runWithInput(Keys::Secret _hostAlias, bytes _packet, NodeID _remoteID)
{
    ...
    auto host = make_shared<Host>("peer name", Keys::Secret(_hostAlias));
