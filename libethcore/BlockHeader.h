...
public:
	...
	void setTimestamp(int64_t const& _v) { m_timestamp = _v; noteDirty(); }
	...
	void setNumber(int64_t const& _v) { m_number = _v; noteDirty(); }
	...
	int64_t const& timestamp() const { return m_timestamp; }
	...
	int64_t const& number() const { return m_number; }
